...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_14552 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_14552(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_14553 = (function (runtime,key,spec){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_14553(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_14566 = (function (runtime,key){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_14566(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_14573 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_14573(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_14584 = (function (runtime,input,callback){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_14584(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_14597 = (function (runtime,code){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_14597(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__14547,callback){
var map__14548 = p__14547;
var map__14548__$1 = cljs.core.__destructure_map(map__14548);
var input = map__14548__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14548__$1,new cljs.core.Keyword(null,"code","code",1586293142));
