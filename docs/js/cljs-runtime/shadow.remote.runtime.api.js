...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_14540 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_14540(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_14541 = (function (runtime,key,spec){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_14541(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_14542 = (function (runtime,key){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_14542(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_14543 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_14543(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_14544 = (function (runtime,input,callback){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_14544(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_14546 = (function (runtime,code){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_14546(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__14534,callback){
var map__14535 = p__14534;
var map__14535__$1 = cljs.core.__destructure_map(map__14535);
var input = map__14535__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14535__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14535__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
