...
var G__21986 = o;
reagent.impl.template.goog$module$goog$object.set(G__21986,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null, v)));
...
while (G__22092__i < G__22092__a.length) {G__22092__a[G__22092__i] = arguments[G__22092__i + 0]; ++G__22092__i;}
  args = new cljs.core.IndexedSeq(G__22092__a,0,null);
} 
...
var G__21989 = o;
reagent.impl.template.goog$module$goog$object.set(G__21989,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__22094__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__22095__i < G__22095__a.length) {G__22095__a[G__22095__i] = arguments[G__22095__i + 0]; ++G__22095__i;}
  args = new cljs.core.IndexedSeq(G__22095__a,0,null);
} 
return G__22094__delegate.call(this,args);};
G__22094.cljs$lang$maxFixedArity = 0;
G__22094.cljs$lang$applyTo = (function (arglist__22096){
var args = cljs.core.seq(arglist__22096);
return G__22094__delegate(args);
});
...
var G__21991 = props;
var G__21991__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__21991,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__21991);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__21991__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5002__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__21993 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__21993,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__21993;
}
})(),id_class);
...
var G__21995 = (cljs.core.count(argv) - first_child);
switch (G__21995) {
case (0):
...
var vec__21998 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21998,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21998,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__21998,(2),null);
...
var temp__5808__auto___22104 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___22104 == null)){
} else {
var key_22105 = temp__5808__auto___22104;
(jsprops.key = key_22105);
}
...
var temp__5808__auto___22106 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___22106 == null)){
} else {
var key_22107 = temp__5808__auto___22106;
(jsprops.key = key_22107);
}
...
var temp__5808__auto___22108 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___22108 == null)){
} else {
var key_22109 = temp__5808__auto___22108;
(jsprops.key = key_22109);
}
...
var temp__5808__auto___22119 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___22119 == null)){
} else {
var key_22120 = temp__5808__auto___22119;
...
var temp__5808__auto___22121 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___22121 == null)){
} else {
var key_22122 = temp__5808__auto___22121;
(jsprops.key = key_22122);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__22017_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__22017_SHARP_);
}),s));
});
...
*/
reagent.impl.template.t_reagent$impl$template22032 = (function (opts,id,fn_to_element,parse_fn,meta22033){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template22032.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_22034,meta22033__$1){
var self__ = this;
var _22034__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template22032(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta22033__$1));
}));

(reagent.impl.template.t_reagent$impl$template22032.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_22034){
var self__ = this;
var _22034__$1 = this;
return self__.meta22033;
}));

(reagent.impl.template.t_reagent$impl$template22032.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template22032.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template22032.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template22032.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template22032.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template22032.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta22033","meta22033",-703990741,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template22032.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template22032.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template22032");

(reagent.impl.template.t_reagent$impl$template22032.cljs$lang$ctorPrWriter = (function (this__5287__auto__,writer__5288__auto__,opt__5289__auto__){
return cljs.core._write(writer__5288__auto__,"reagent.impl.template/t_reagent$impl$template22032");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template22032.
 */
reagent.impl.template.__GT_t_reagent$impl$template22032 = (function reagent$impl$template$__GT_t_reagent$impl$template22032(opts,id,fn_to_element,parse_fn,meta22033){
return (new reagent.impl.template.t_reagent$impl$template22032(opts,id,fn_to_element,parse_fn,meta22033));
});
...
return (new reagent.impl.template.t_reagent$impl$template22032(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
