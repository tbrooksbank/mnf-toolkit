...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_21988 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_21988(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_21990 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_21990(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_21992 = (function (reader,ch){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_21992(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_21994 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_21994(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_21996 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_21996(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_21997 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_21997(reader);
}
});
...
var G__22015 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null, );
var G__22016 = s.append(c);
c = G__22015;
s = G__22016;
continue;
}
